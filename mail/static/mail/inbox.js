document.addEventListener('DOMContentLoaded',()=> {
  ...
  //this eventlistener is for form submission so that email can be sent
...
function load_mailbox(mailbox) {
  ...
  .then(emails =>{
    emails.forEach(email=>{
      ...
      new_email.addEventListener('click',()=>load_email(new_email.id));
...
function load_email(email_id){
  //next 3 lines for showing email view and hide other views
  document.querySelector('#emails-view').style.display='none';
